...
const LoginPage = () => {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif" }} className="min-h-screen flex bg-[#1C1A14]">

      {/* ── LEFT PANEL ── */}
      <div className="relative hidden lg:flex flex-1 flex-col justify-end p-12 overflow-hidden">
      ...
      {/* ── RIGHT PANEL ── */}
      <div className="w-full lg:w-[480px] lg:flex-shrink-0 bg-[#F5F0E8] flex flex-col justify-center px-10 py-14 relative">
        {/* Accent top bar */}
        <div
          ...
          <div className="flex items-center justify-between">
            <label className="flex items-center gap-2 cursor-pointer select-none">
              <div
                ...
                className={`w-4.5 h-4.5 w-[18px] h-[18px] rounded-[5px] border flex items-center justify-center transition-all cursor-pointer ${
                  rememberMe
